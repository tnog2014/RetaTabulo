...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
	...
	public void registerStompEndpoints(StompEndpointRegistry registry) {
		LOGGER.info("allowedOrigins:[" + propertyAccessor.getAllowedOrigins() + "]");
		registry.addEndpoint("/tabulo-websocket")
				.setAllowedOrigins(propertyAccessor.getAllowedOrigins()).withSockJS();
	}
